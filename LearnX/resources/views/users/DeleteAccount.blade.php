                    ...
                    <div class="text-xl font-sans m-4">
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="items-center">
                                <div>
                                    <input class="w-75 h-15 border-black border-solid border-2 p-3 text-lg" type="text" id="name" name="name" placeholder="Name" value="{{old('name')}}">
                                    @error('name')
                                ...
                                <div class= "">
                                    <input class="font-Preahvihear text-xl no-underline border-none cursor-pointer text-blue-600 hover:text-blue-800" type="submit" id="submit" name="submit" value="Lets Go >>>">
                                </div>
