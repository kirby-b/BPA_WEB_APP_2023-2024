...
<body>
     <div class="width-full h-24.25 font-Preahvihear text-left text-3xl rounded border-black border-solid bg-center bg-cover bg-[url('/Images/School-Supplies.jpg')]">{{--Top-div-info-page --}}
        <div>
            <div>
                <p>LearnX</p>
            </div>
...
<div class="w-64.25 h-31.875 font-BalsamiqSans border-black border-solid border-7 absolute text-4xl bg-violet-400">
    <div>
        A+ Students
    </div>
    <div>
...
<div class="Preahvihear text-center text-3xl absolute width-full h-17 bg-center bg-cover bg-[url('/Images/Light-Rainbow-Gradient.jpg')] mt-550 border-7 border-solid border-black">
    <div>
