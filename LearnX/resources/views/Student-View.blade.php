...
<body>
    ...
    <div class="border-2 border-solid border-black font-Preahvihear text-3xl text-left h-24 w-full">
        <div>
                <div class="absolute ml-200"><img src="/Images/LearnX_Logo.png" alt="Image cannot load" width="90px" height="100px"></div>
                ...
                <div class="absolute ml-85/100 mt-3"><!--pfp--><a href={{ route("page.profile") }}><img src="/Images/Default_Pfp.png" alt="Image cannot load" width="90px" height="90px"></a></div><!--Image by qalebstudio on Freepik-->
