            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        907-960: Period of the Five Dynasties and Ten Kingdoms in China.<br>
                        909: Fatimid Caliphate is founded in North Africa.<br>
                        945: Abbasid Caliphate recovers Baghdad from the Buyids.<br>
                        960-1279: Song Dynasty in China.<br>
                        962: Otto I is crowned Holy Roman Emperor.<br>
                        976-1031: Reign of Al-Hakam II in Cordoba's Golden Age.<br>
                        980-1016: Reign of Vladimir the Great in Kievan Rus'.<br>
                        988: Christianization of Kievan Rus' under Vladimir the Great.<br>
                        991: Battle of Maldon between the English and Vikings.<br>
                        1002-1014: Æthelred the Unready's tribute payments to the Vikings.<br>
                    </p>
                </div>
            </div>
        </div>
