            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        312: Battle of the Milvian Bridge and Constantine's conversion to Christianity.<br>
                        324: Constantine becomes the sole Roman Emperor.<br>
                        325: First Council of Nicaea.<br>
                        330: Constantinople becomes the capital of the Roman Empire.<br>
                        337: Death of Roman Emperor Constantine the Great.<br>
                        363: Battle of Ctesiphon in the Roman-Persian Wars.<br>
                        378: Battle of Adrianople between the Romans and Visigoths.<br>
                        380: Edict of Thessalonica declares Christianity the state religion of the Roman Empire.<br>
                        391: Closing of the ancient Academy of Athens by the Roman Emperor Theodosius I.<br>
