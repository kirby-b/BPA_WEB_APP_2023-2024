            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        1405-1433: Zheng He's voyages across the Indian Ocean.<br>
                        1431: Joan of Arc is executed.<br>
                        1450-1455: Gutenberg prints the first Bible using movable type.<br>
                        1453: Fall of Constantinople to the Ottoman Empire.<br>
                        1478-1834: Spanish Inquisition is established.<br>
                        1485: Battle of Bosworth Field - End of the Wars of the Roses.<br>
                        1492: Reconquista concludes with the capture of Granada.<br>
                        1492: Christopher Columbus reaches the Americas.<br>
                        1492: The Alhambra Decree expels Jews from Spain.<br>
                        1498: Vasco da Gama reaches the shores of India.<br>
                    </p>
                </div>
            </div>
        </div>
