            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        711: Battle of Guadalete - Umayyad conquest of the Visigothic Kingdom.<br>
                        711-750: Umayyad Caliphate.<br>
                        711-1492: Muslim rule in Al-Andalus (Iberian Peninsula).<br>
                        717-718: Siege of Constantinople by the Umayyads.<br>
                        732: Battle of Tours - Charles Martel defeats the Umayyad Caliphate.<br>
                        749-750: Abbasid Revolution and the fall of the Umayyad Caliphate.<br>
                        751: Abbasid Revolution leads to the establishment of the Abbasid Caliphate.<br>
                        756: Foundation of the Emirate of Cordoba in Al-Andalus.<br>
                        762: Foundation of Baghdad as the new capital of the Abbasid Caliphate.<br>
                        787: The Second Council of Nicaea.<br>
                    </p>
                </div>
            </div>
        </div>
