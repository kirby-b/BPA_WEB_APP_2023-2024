            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        1202-1204: Fourth Crusade.<br>
                        1206: Genghis Khan unites the Mongol tribes.<br>
                        1206-1368: Mongol Yuan Dynasty in China.<br>
                        1215: Magna Carta is sealed by King John of England.<br>
                        1219-1221: Mongol invasion of Khwarazm.<br>
                        1227: Death of Genghis Khan.<br>
                        1237-1242: Mongol invasion of Europe - Battle of Legnica.<br>
                        1260: Battle of Ain Jalut - Mamluks defeat the Mongols.<br>
                        1271-1295: Marco Polo travels to China.<br>
                        1291: Fall of Acre - End of the Crusader states.<br>
                    </p>
                </div>
            </div>
        </div>
