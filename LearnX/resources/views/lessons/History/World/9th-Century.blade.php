            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        800: Charlemagne is crowned Emperor of the Romans by Pope Leo III.<br>
                        813-833: Iconoclasm Controversy in the Byzantine Empire.<br>
                        827-902: The Great Heathen Army of the Vikings invades England.<br>
                        843: Treaty of Verdun divides the Carolingian Empire into three parts.<br>
                        850-1100: Viking Age.<br>
                        860-885: Rus' Byzantine War.<br>
                        869-870: Fourth Council of Constantinople.<br>
                        874: Iceland is settled by Norsemen.<br>
                        899: Death of Alfred the Great, King of Wessex.<br>
                        907: The Tang Dynasty falls in China.<br>
                    </p>
                </div>
            </div>
        </div>
