            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        1000-1100: Medieval Warm Period.<br>
                        1030: Death of Olaf II of Norway at the Battle of Stiklestad.<br>
                        1037-1194: Almoravid Empire in North Africa and Al-Andalus.<br>
                        1054: Great Schism between the Eastern Orthodox and Roman Catholic Churches.<br>
                        1066: Battle of Hastings - Norman Conquest of England.<br>
                        1071: Battle of Manzikert - Seljuk Turks defeat the Byzantine Empire.<br>
                        1073-1085: Reign of Pope Gregory VII.<br>
                        1086: Battle of Sagrajas - Almoravids defeat Castile and Leon.<br>
                        1095: Pope Urban II calls for the First Crusade at the Council of Clermont.<br>
                        1096-1099: First Crusade.<br>
                    </p>
                </div>
            </div>
        </div>
