            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        105: Han Dynasty collapses, leading to the Three Kingdoms period.<br>
                        105-106: Roman Emperor Trajan's conquest of Dacia.<br>
                        105-114: Roman Emperor Trajan's campaigns in Dacia.<br>
                        132-136: Bar Kokhba revolt against Roman rule in Judea.<br>
                        143-163: Antonine Plague.<br>
                        166-180: Reign of Roman Emperor Marcus Aurelius.<br>                        
                        161: The Roman Empire reaches its height under Antoninus Pius.<br>
                        180: End of the Pax Romana.<br>
                        184: Yellow Turban Rebellion in China.<br>
                        226: Fall of the Parthian Empire and rise of the Sassanian Empire.<br>
                    </p>
                </div>
            </div>
        </div>
