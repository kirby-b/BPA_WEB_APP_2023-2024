            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        1517: Martin Luther's Ninety-Five Theses initiate the Protestant Reformation.<br>
                        1521: Cortés conquers the Aztec Empire.<br>
                        1556-1605: Akbar the Great rules the Mughal Empire.<br>
                        1562-1598: French Wars of Religion.<br>
                        1571: Battle of Lepanto - Holy League defeats the Ottoman Empire.<br>
                        1588: Defeat of the Spanish Armada by the English navy.<br>
                        1590: Battle of Ivry - Henry IV becomes King of France.<br>
                        1598: Edict of Nantes grants religious tolerance in France.<br>
                        1599: Peace of Vervins ends the war between Spain and France.<br>
                        1600: Battle of Sekigahara unifies Japan under the Tokugawa shogunate.<br>
                    </p>
                </div>
            </div>
        </div>
