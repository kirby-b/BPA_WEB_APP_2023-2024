            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        1305-1378: Avignon Papacy.<br>
                        1315-1317: Great Famine in Europe.<br>
                        1337-1453: Hundred Years' War.<br>
                        1340: Battle of Sluys in the Hundred Years' War.<br>
                        1346: Battle of Crécy - English victory in the Hundred Years' War.<br>
                        1347-1351: Black Death pandemic.<br>
                        1356: Battle of Poitiers - English capture King John II of France.<br>
                        1368-1644: Ming Dynasty in China.<br>
                        1378-1417: Western Schism in the Catholic Church.<br>
                        1386-1389: Ottoman victory at the Battle of Kosovo.<br>
                    </p>
                </div>
            </div>
        </div>
