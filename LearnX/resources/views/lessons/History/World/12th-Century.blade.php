            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        1122: Concordat of Worms between the Holy Roman Empire and the Catholic Church.<br>
                        1139: Second Lateran Council.<br>
                        1145-1149: Wendish Crusade in Northern Europe.<br>
                        1147-1149: Second Crusade.<br>
                        1154-1189: Reign of Henry II of England.<br>
                        1170: Murder of Thomas Becket in Canterbury Cathedral.<br>
                        1171: Saladin conquers Jerusalem.<br>
                        1187: Battle of Hattin - Saladin defeats the Crusaders.<br>
                        1189-1192: Third Crusade.<br>
