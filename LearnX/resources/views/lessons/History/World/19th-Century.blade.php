            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        1803: Louisiana Purchase in the United States.<br>
                        1804-1814: Haitian Revolution.<br>
                        1815: Battle of Waterloo - End of the Napoleonic Wars.<br>
                        1830: Revolutions of 1830 in Europe.<br>
                        1848: Revolutions of 1848 in Europe.<br>
                        1859: Publication of Charles Darwin's "On the Origin of Species."<br>
                        1861-1865: American Civil War.<br>
                        1868: Meiji Restoration in Japan.<br>
                        1871: Unification of Germany.<br>
