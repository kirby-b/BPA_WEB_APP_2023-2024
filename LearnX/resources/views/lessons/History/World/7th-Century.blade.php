            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        622: Hijra (migration) of Prophet Muhammad from Mecca to Medina.<br>
                        622: Beginning of the Islamic calendar.<br>
                        622: The Pact of Umar establishes guidelines for the treatment of non-Muslims under Islamic rule.<br>
                        628: Treaty of Hudaybiyyah between the Muslims and the Quraysh.<br>
                        632: Death of Prophet Muhammad.<br>
                        632-661: The Rashidun Caliphate.<br>
                        636-642: Arab conquest of Byzantine and Sassanian territories.<br>
                        681-828: The establishment of the Abbasid Caliphate.<br>
                        681-682: The Sixth Ecumenical Council in Constantinople.<br>
                        711: Umayyad conquest of the Iberian Peninsula.<br>
                    </p>
                </div>
            </div>
        </div>
