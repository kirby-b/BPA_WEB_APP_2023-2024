            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        200-210: Severan dynasty rule in the Roman Empire.<br>
                        212: Roman Emperor Caracalla's Constitutio Antoniniana grants citizenship to all free men in the Roman Empire.<br>
                        220: Three Kingdoms period begins in China.<br>
                        224: Sassanian Empire defeats the Parthians and emerges in Persia.<br>
                        235: Assassination of Roman Emperor Alexander Severus.<br>
                        235-284: Crisis of the Third Century in the Roman Empire.<br>
                        238-244: Reign of Roman Emperor Gordian III.<br>
                        251: The Battle of Abrittus between the Roman Empire and the Goths.<br>
                        260: Destruction of the Roman Temple of Sol Invictus.<br>
                        260-273: Palmyrene Empire in the eastern Roman Empire.<br>
                    </p>
                </div>
            </div>
        </div>
