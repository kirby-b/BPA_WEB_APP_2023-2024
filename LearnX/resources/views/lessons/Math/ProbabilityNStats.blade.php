            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        Probability and statistics are two branches of mathematics that deal with uncertainty, randomness, and data analysis.
                        <span class="italic">Probability</span> involves studying the likelihood of events occurring in various situations. It provides a framework to quantify uncertainty. The basic idea is to assign a numerical value between 0 and 1 to the likelihood of an event happening, where 0 indicates impossibility, 1 indicates certainty, and values in between represent degrees of likelihood. For example, the probability of getting heads when flipping a fair coin is 0.5 (or 50%).
                        <span class="italic">Statistics</span>, on the other hand, involves collecting, analyzing, interpreting, and presenting data. It helps in making inferences or conclusions about a larger population based on a sample of data. Statistics includes various methods for summarizing data (descriptive statistics) and making predictions or drawing conclusions from data (inferential statistics).
                        Descriptive statistics involve measures like mean, median, mode, variance, and standard deviation, which help in summarizing and describing the main features of a dataset.
                        Inferential statistics uses probability theory to make predictions or draw conclusions about a population based on a sample. This includes techniques like hypothesis testing, regression analysis, confidence intervals, and more.
                        Probability and statistics are used extensively in various fields such as science, economics, social sciences, engineering, and more, to model uncertainty, make predictions, and draw meaningful insights from data.
                    </p>
                </div>
            </div>
        </div>
