            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <span class="font-extrabold">Fractions, Decimals, & Percentages:</span><br>
                        ...
                        <span class="font-semibold">Addition and Subtraction:</span> To add or subtract fractions, the denominators need to be the same. If they aren't, you'll need to find a common denominator. Once the denominators are the same, you can add or subtract the numerators while keeping the denominator unchanged.<br>
                        ...
                        <span class="font-semibold">Addition and Subtraction:</span> Align the decimal points and perform addition or subtraction as you would with whole numbers.<br>
                        <span class="font-semibold">Multiplication:</span> Multiply the numbers as if they were whole numbers and then adjust the decimal point in the product. The total number of decimal places in the product is the sum of the decimal places in the factors.<br>
                        ...
                        Example: 68% or 39%<br>
                        <span class="font-semibold">Calculations:</span> Percentages are used for calculations involving increases, decreases, discounts, taxes, tips, and interest rates.<br>
                        <span class="font-semibold">Comparisons:</span> They're useful for comparing quantities relative to a whole. For instance, if there are 80 boys in a class of 200 students, the percentage of boys is 80/200 x 100% = 40%.<br>
                        <span class="font-semibold">Conversions:</span> Converting between percentages, fractions, and decimals is common. For example, 25% is equivalent to 25/100 as a fraction and 0.25 as a decimal.<br>
                        <span class="font-semibold">Calculating Percentages:</span> To find a percentage of a number, you multiply the number by the percentage written as a decimal. For example, 20% of 150 is 0.20 x 150 = 30.<br>
                        <span class="font-semibold">Percentage Increase or Decrease:</span> When a quantity increases or decreases by a certain percentage, you can calculate the new value by adding or subtracting the appropriate percentage. For instance, a 20% increase in 100 is 100 + (0.20 x 100) = 120.<br>
                    </p>
                </div>
            </div>
        </div>
