            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <span class="font-semibold">Matter:</span> Everything around us is made up of matter, which comprises atoms and molecules. Chemistry explores the properties of matter and how different substances interact.<br>
                        <br>
                        <span class="font-semibold">Elements and Compounds:</span> Elements are the simplest forms of matter, consisting of one type of atom. They combine to form compounds, which are substances made of two or more elements in fixed proportions.<br>
                        <br>
                        ...
                        <br>
                        <span class="font-semibold">Acids and Bases:</span> Acids and bases are important chemical substances with distinct properties. Understanding their behavior helps explain phenomena like pH, corrosion, and reactions in living organisms.<br>
                        <br>
                        <span class="font-semibold">Thermodynamics:</span> Focuses on the relationship between heat, energy, and work in chemical reactions and physical processes. It explains the principles governing energy transfer and transformation.<br>
                        <br>
                        ...
                        <br>
                        <span class="font-semibold">Organic and Inorganic Chemistry:</span> Organic chemistry studies carbon-containing compounds, including those found in living organisms, while inorganic chemistry focuses on non-carbon compounds.<br>
                    </p>
                </div>
            </div>
        </div>
