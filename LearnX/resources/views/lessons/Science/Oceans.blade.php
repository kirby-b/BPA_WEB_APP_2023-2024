            ...
            <div class="flex flex-col md:flex-row justify-center items-center md:space-x-6">
                ...
                <div class="md:w-1/2 p-4 bg-white border-2 border-gray-300 rounded-lg shadow-lg">
                    <p class="text-xl font-sans m-4">
                        ...
                        <br>
                        <span class="font-semibold">Biological Oceanography:</span> This field explores the diverse life forms in the oceans, from microscopic plankton to large marine mammals. Biological oceanographers study marine ecosystems, food webs, biodiversity, behavior, reproduction, and the adaptations of organisms to various ocean conditions.<br>
                        <br>
                        <span class="font-semibold">Geological Oceanography:</span> Geological oceanographers examine the ocean floor, including its topography, sediments, and geological formations. They study the processes of plate tectonics, underwater volcanoes, seafloor spreading, and the history of Earth's geology recorded in marine sediments and rocks.<br>
                        <br>
                        <span class="font-semibold">Marine Ecology:</span> Marine ecologists focus on the relationships between organisms and their environments in the ocean. They study how factors like temperature, salinity, nutrient availability, and human impacts affect marine ecosystems and biodiversity.<br>
                        <br>
                        <span class="font-semibold">Paleoceanography:</span> This branch involves studying the history of the oceans, including past climate changes, ocean circulation patterns, and ancient marine life, often using sediment cores and fossil records to understand long-term changes in the oceans.<br>
                    </p>
                </div>
            </div>
        </div>
