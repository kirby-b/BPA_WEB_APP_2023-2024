...
<body>
     <div class="width-full h-24.25 font-Preahvihear text-left text-3xl border-black border-solid bg-center bg-cover bg-[url('/Images/School-Supplies.jpg')]">{{--Top-div-info-page --}}
        <div>
            <div>
                <p>LearnX</p>
            </div>
...
<div class="Preahvihear text-center text-3xl absolute width-full h-17 bg-center bg-cover bg-[url('/Images/Light-Rainbow-Gradient.jpg')] mt-552 border-7 border-solid border-black">
    <div>
